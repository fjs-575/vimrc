...
let colors_name = "xoria256_fjs"
"}}}
" Colours {{{1
"" General {{{2
hi Normal       ctermfg=252 guifg=#d0d0d0 ctermbg=016 guibg=#000000 cterm=none gui=none
...
hi LineNr       ctermfg=247 guifg=#9e9e9e ctermbg=233 guibg=#000000
...
hi StatusLine   ctermfg=15  guifg=#ffffff ctermbg=235 guibg=#262626 cterm=bold gui=bold
